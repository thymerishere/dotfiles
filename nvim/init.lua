...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Add luasnip keybind
      vim.keymap.set('n', '<leader>sl', require('telescope').extensions.luasnip.luasnip, { desc = '[S]earch [L]uasnip' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Separate setup for sourcekit as it is picky for some reason
